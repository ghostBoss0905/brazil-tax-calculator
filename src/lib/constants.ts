export const BRAZILIAN_STATES = [
  ...
  { code: "RS", name: "Rio Grande do Sul", rate: 17 },
  { code: "SC", name: "Santa Catarina", rate: 17 },
  { code: "SE", name: "Sergipe", rate: 19 },
  { code: "SP", name: "São Paulo", rate: 18 },
  { code: "TO", name: "Tocantins", rate: 20 },
];
...
export const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Sim. O ICMS é um imposto estadual, por isso o valor pode mudar conforme o estado de destino da encomenda.",
  },
  {
