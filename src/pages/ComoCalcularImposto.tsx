export default function ComoCalcularImposto() {
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "40px" }}>
      ...
      <p>
        Comprar produtos internacionais na Shopee, AliExpress, Amazon ou Shein
        ficou mais caro após as novas regras de importação no Brasil.
      </p>

      <p>
        Neste guia atualizado de 2026, você aprenderá como calcular imposto de
        importação no Brasil passo a passo.
      </p>
      ...
      <p>
        Dependendo do estado, o valor final pode ultrapassar R$900 após ICMS e
      ...
      <p>
        Para calcular automaticamente todos os impostos de importação no Brasil,
        utilize nossa ferramenta gratuita:
      </p>
